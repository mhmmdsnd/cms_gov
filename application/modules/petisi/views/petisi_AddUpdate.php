...
<?php if ($_SERVER['REQUEST_URI'] == "/petisi/create") { ?>
<script type="text/javascript">
$(document).ready(function(){
...
<form method="post" id="petisi_form" name="petisi_form" class="form-horizontal" role="form" enctype="multipart/form-data" >
 <input type="hidden" name="casestate" value="3" />
 <input type="hidden" name="casetype" value="5" />
 <div class="form-group">
    <label class="col-sm-3 control-label no-padding-right">Petitions Title</label>
    <div class="col-sm-9">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <textarea name="casecontent" data-provide="markdown" data-iconlibrary="fa" rows="10"></textarea>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-md-offset-3 col-md-9">
      ...
      &nbsp; &nbsp; &nbsp;
      <input type="button" value="Cancel" class="btn btn-primary" onclick="document.location.replace('<?php echo base_url();?>petisi');" />
    </div>
  </div>
</form>
<?php } else { ?>
<form method="post" id="newcase_form" name="newcase_form" class="form-horizontal" role="form">
  ...
  <div class="form-group">
   ...
   <div class="col-sm-9">
        <div class="input-group">
            ...
            <input class="col-xs-3" type="text" name="casedate" id="casedate" readonly="readonly" value="<? echo $detail->caseDateStart ?> / <? echo $detail->caseDateEnd ?>"/>
        </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <label class="col-sm-3 control-label no-padding-right">Content</label>
    <div class="col-sm-9">
      <textarea name="casecontent" data-provide="markdown" data-iconlibrary="fa" rows="10"><? echo $detail->caseContent ?></textarea>
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-3 control-label no-padding-right">File Attachment</label>
